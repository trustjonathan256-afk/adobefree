...
export default function NFTCard({
    ...
    return (
        <div className="cursor-pointer bg-card rounded-[1.5rem] sm:rounded-[2rem] lg:rounded-[2.5rem] overflow-hidden border border-card-border flex flex-col group transition-all duration-300 hover:scale-[1.01] hover:shadow-2xl hover:shadow-accent/5">
            {/* Image Section */}
